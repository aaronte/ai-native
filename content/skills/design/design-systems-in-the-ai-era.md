...
**Docs as prompts**: Add **copy-paste prompts** for internal agents (“generate a primary button using `@acme/button`”). Keep **screenshots and code snippets** synchronized; stale docs train **bad habits**.

**Governance**: Run **monthly system health reviews**: unused components, conflicting patterns, a11y debt. Introduce **contribution rules** so AI-suggested new components go through **human review and naming**.
